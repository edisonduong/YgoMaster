...
- The Colosseum UI supplies Find Match / Cancel Search, Select Standard Deck, validity errors, queue position, and elapsed time. It polls every two seconds through `Request.Entry`. Leaving the screen cancels search. Estimated wait is explicitly unknown rather than fabricated.
